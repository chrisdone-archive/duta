...
RUN curl --silent https://github.com/chrisdone/duta/archive/979681116a662ebf2d4c1d953138fb16b5a5786a.zip -L \
    -o duta.zip && unzip duta.zip && rm duta.zip
WORKDIR duta-979681116a662ebf2d4c1d953138fb16b5a5786a
